...
public class Demo_diagnosis {
    public static void main(String[] args) throws Exception {
        // 从实例数据与规则文件创建各自的文件对象
        File dataFile = new File(Demo_diagnosis.class.getResource("/data/diagnosis_data.nt").toURI());
        File ruleFile = new File(Demo_diagnosis.class.getResource("/data/diagnosis_rule.txt").toURI());
        // 创建数据存储
